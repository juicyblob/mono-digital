...
Проект разработан с акцентом на чистую верстку, плавные анимации и удобство взаимодействия.

## ✨ О проекте

Это полностью адаптивный лендинг, демонстрирующий навыки frontend-разработки, реализованные кейсы и ключевые компетенции.

Основная цель — создать минималистичный, но выразительный интерфейс:
